...
Function AgsiandAlsiDataExport($url , $Path)
{
$response = Invoke-RestMethod -v -H @{'x-key' = '6decec532c4f381d76377e1c37e0a0e8'} $url
$response | Export-Csv  -Path $Path  -NoTypeInformation -Force
}
...
AgsiandAlsiDataExport $url $NewPath
}
# ALSI Export
