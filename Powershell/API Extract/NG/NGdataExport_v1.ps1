...
'System Entry Calorific Value, South Hook, D+1',
...
function NGDataExport($URI,$xmlFile,$FileCSV,$xmldataobject,$count, $object)
...
NGDataExport $URI $xmlFile $FileCSV $xmldataobject $count $object
