...
Remove-Item -Path 'D:\Data\Montel\*.csv'
...
$FileHistory = "D:\Data\Montel\History\MontelData_"+$(((get-date).ToUniversalTime()).ToString("yyyyMMddThhmmZ"))+".csv"
...
$Result.Elements | Export-csv -Path $FileHistory -Append -Force -NoTypeInformation
}
